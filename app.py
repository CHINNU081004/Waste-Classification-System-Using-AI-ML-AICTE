...
st.markdown(
    ...
    <div style="text-align: center; font-family: Arial, sans-serif; font-size: 14px;">  <!-- Reduced font size -->
        ...
        <b style="font-size: 16px;">Made by:</b> B Hemanth Reddy<br>
        <a href="www.linkedin.com/in/hemanth-reddy-855712282/" target="_blank" style="color: #333; font-size: 16px;">LinkedIn</a> | 
        <a href="https://https://github.com/CHINNU081004" target="_blank" style="color: #333; font-size: 16px;">GitHub</a><br><br>
